ninja.translator = {
	...
	translations: {
		...
		"es": {
			...
			"singletip1": "<b>A Litecoin wallet</b> is as simple as a single pairing of a Litecoin address with its corresponding Litecoin private key. Such a wallet has been generated for you in your web browser and is displayed above.", //TODO: please translate
			"singletip2": "<b>To safeguard this wallet</b> you must print or otherwise record the Litecoin address and private key. It is important to make a backup copy of the private key and store it in a safe location. This site does not have knowledge of your private key. If you are familiar with PGP you can download this all-in-one HTML page and check that you have an authentic version from the author of this site by matching the SHA1 hash of this HTML with the SHA1 hash available in the signed version history document linked on the footer of this site. If you leave/refresh the site or press the \"Generate New Address\" button then a new private key will be generated and the previously displayed private key will not be retrievable. Your Litecoin private key should be kept a secret. Whomever you share the private key with has access to spend all the litecoins associated with that address. If you print your wallet then store it in a Ziploc bag to keep it safe from water. Treat a paper wallet like cash.", //TODO: please translate
			...
			"singletip4": "<b>Check your balance</b> by going to http://explorer.litecoin.net or http://block-explorer.com and entering your Litecoin address.", //TODO: please translate
			"singletip5": "<b>Spend your litecoins</b> by downloading Litecoin-Qt from http://litecoin.org and importing your private key into the application. Keep in mind when you import your single key and spend funds with Litecoin-Qt, your key will be bundled with other private keys in the wallet. When you perform a transaction, your change will be sent to another Litecoin address within Litecoin-Qt. You must then backup Litecoin-Qt and keep the data safe, as your remaining litecoins will be stored there, not just at your original address. Satoshi advised that one should never delete a wallet.", //TODO: please translate
